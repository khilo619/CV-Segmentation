...
def test_font_hierarchy_extractor(
    sample_page_start: PagePayload, sample_page_continuation: PagePayload
) -> None:
...
def test_syntactic_continuity() -> None:
    ...
    page1 = PagePayload(
        ...
        width=600,
        height=800,
        text="Responsibilities include managing teams and",
        char_count=45,
    )
    page2 = PagePayload(
        page_index=1,
        width=600,
        height=800,
        text="overseeing production deployments.",
        char_count=35,
    )
...
def test_heuristic_gating_engine(
    sample_page_start: PagePayload, sample_page_continuation: PagePayload
) -> None:
